...
<body>
    <div class="">
        <div class="row justify-content-around">
            <!-- main board -->
            <div class="col-xl-3 left-nav-bar">
                <div class="card card-custom gutter-b card-stretch">
                    <div class="card-header border-0 pt-5">
                        <div class="card-title">
                            <div class="card-label">
                                <div class="font-weight-bolder">Account</div>
                                <div class="font-size-sm text-muted mt-2">User.ID._7877EUikfhik</div>
                            </div>
                        </div>
                                    ...
                                    <ul class="navi navi-hover py-5">
                                        ...
                                        <li class="navi-item">
                                            <a href="#" class="navi-link">
                                                ...
                                                <span class="navi-text">Payments</span>
                                            </a>
                                        </li>
                    ...
                    <div class="card-body d-flex flex-column px-0" style="position: relative;">
                        <!--begin::Chart-->
                        <div id="kt_tiles_widget_1_chart" data-color="danger" style="height: 125px; min-height: 125px;">
            ...
            <!-- content board -->
            <div class="col-xl-8 right-content-bar">
                <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <div class="contact-summary d-flex justify-content-between" style="font-size: 6px; margin-top: 20px;">
                            ...
                            <div>
                                <div style="font-weight: 800">Spend</div>
                                <div>US$45000</div>
                            </div>
                            <div>
                    ...
                    <!-- related to person and company profile's edit page -->
                    <div class="col-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="example mb-10">
                                    <p>Responsive tables allow tables to be scrolled horizontally with ease. Make any
                                        table responsive across all viewports by wrapping a
                                        <code>.table</code>with
                                        <code>.table-responsive</code>. Or, pick a maximum breakpoint with which to have
                                    ...
                                    <div class="example-code">
                                        ...
                                        <div class="example-highlight">
                                            <pre
                                                class=" language-html"><code class=" language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>table-responsive<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span></code></pre>
                                ...
                                <div class="example mb-10">
                                    ...
                                    <div class="example-code">
                                        ...
                                        <div class="example-highlight">
                                            <pre
                                                class=" language-html"><code class=" language-html"><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>div</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>table-responsive-lg<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>table</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>table<span class="token punctuation">"</span></span><span class="token punctuation">&gt;</span></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>table</span><span class="token punctuation">&gt;</span></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>div</span><span class="token punctuation">&gt;</span></span></code></pre>
    ...
    <script src="https://cdn.bootcdn.net/ajax/libs/twitter-bootstrap/4.1.0/js/bootstrap.bundle.min.js"></script>
</body>
