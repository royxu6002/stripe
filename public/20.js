...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("h4", { staticClass: "mt-3" }, [_vm._v("Welcome")]),
    _vm._v(" "),
    _c("h5", [
      _vm._v(
        "\n        " + _vm._s(_vm.$store.state.auth.userInfo.name) + "\n    "
      )
    ]),
    _vm._v(" "),
    _c("p", [_vm._v(_vm._s(_vm.$store.state.auth.userInfo.email))]),
    _vm._v(" "),
    _c("p", [_vm._v(_vm._s(_vm.$store.state.auth.userInfo.phone))])
  ])
}
var staticRenderFns = []
