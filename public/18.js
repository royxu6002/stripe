      ...
      _c(
        ...
        [
          ...
          _vm._l(_vm.order[0].skus, function(sku, index) {
            return _c("tr", { key: index }, [
              ...
              _c("td", {
                domProps: {
                  textContent: _vm._s(
                    sku.length + "x" + sku.width + "x" + sku.height + "mm"
                  )
                }
              }),
              _vm._v(" "),
              _c("td", {
                domProps: { textContent: _vm._s(sku.pcs_in_carton) }
              }),
              _vm._v(" "),
              _c("td", {
          ...
          _c("tr", { staticClass: "font-weight-bold" }, [
            _c("td", { attrs: { colspan: "3", rowspan: "2" } }, [
              _vm._v("\n                    Total\n                ")
            ]),
            _vm._v(" "),
            _c("td", {
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("th", [_vm._v("\n                    Item\n                ")]),
      _vm._v(" "),
      _c("th", [_vm._v("Carton Size")]),
      _vm._v(" "),
      _c("th", [_vm._v("PCS In Carton")]),
      _vm._v(" "),
