...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])('auth', ['userOrders'])), Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])('auth', ['userInfo'])), {}, {
    ...
    _c("div", { staticClass: "container mt-4" }, [
      ...
      _c(
        ...
        [
          _vm._m(0),
          _vm._v(" "),
          _vm._l(_vm.order[0].products, function(product, index) {
            return _c("tr", { key: index }, [
              ...
              _c("td", { attrs: { align: "right" } }, [
                _vm._v(_vm._s(_vm._f("myCurrency")(_vm.lineTotal(product))))
              ])
            ])
          }),
          _vm._v(" "),
          _c("tr", { staticClass: "font-weight-bold" }, [
            ...
            _c("td", [
              _vm._v(
                "\n                    " +
                  _vm._s(_vm.orderQuantity(_vm.order[0].products)) +
                  "\n                "
              )
            ]),
            _vm._v(" "),
            _c("td", { attrs: { align: "right" } }, [
              _vm._v(
                "\n                    " +
                  _vm._s(
                    _vm._f("myCurrency")(_vm.orderTotal(_vm.order[0].products))
                  ) +
                  "\n                "
              )
            ])
